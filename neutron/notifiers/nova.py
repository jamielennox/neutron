...
class Notifier(object):
    ...
    def __init__(self):
        ...
        if not auth:
            LOG.warning('Authenticating to nova using nova_admin_* options is '
                        'deprecated. This should be done using '
        ...
        session = ks_session.Session.load_from_conf_options(cfg.CONF, 'nova')
